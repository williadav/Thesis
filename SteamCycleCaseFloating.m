function [x_keys, z_keys, sol] = ...
    SteamCycleCaseFloating(n, x_0, z_0, constants, control)
    import casadi.*
    ...
    % Control
    x = [x; interrmIn;interrTs;interrW];
    ...
    Alg = [Alg; Dummy1; Dummy2; Dummy3; Dummy4; Dummy5];

    % Add error to ode
    diff = [diff; errmIn; errTs; errW]; 
