...
if ~isempty(load_from_file) && Hex_only
    ...
    z_0 = [z_0; dummy_zm_guess; dummy_m_in_SP; dummy_zV_guess];
...
elseif ~isempty(load_from_file) && ~Hex_only
    ...
    num_z = 10*n+1+29; % Number of z variables (hex + inlet + other)
...
for i = 1:N
    ...
    % Evaluate system 
    [xf_keys, zf_keys, result] = C3FeedbackConstP(n, x, z, constants, control); 
    x = result.xf;
    z = result.zf;
