function [x_keys, z_keys, sol] = Openloop(n, x_0, z_0, constants)
    import casadi.*
    ...
    L       = constants(29);
    mP0     = constants(30);
    m_cold_in = constants(31);
    T_cold_in = constants(32);
    k_c     = constants(33);
    p_out   = constants(34);
    U_c     = constants(35);
    A_c     = constants(36);
    Vc      = constants(37);
    A_anto_c= constants(38);
    B_anto_c= constants(39);
    C_anto_c= constants(40);
    eta     = constants(41);
    VT      = constants(42);
    ...
    m_cold_out = SX.sym('m_cold_out');
    T_cold_out = SX.sym('T_cold_out');
    Qc = SX.sym('Qc');
    ...
    z = [z; m_s; Ts; TBs; pS; hS; beta_s; rho_s; m_T; TT; TBT; pT; hT; ...
        ...
        pc; hc; rho_c; m_cold_out; T_cold_out; Qc];
    ...
    %% Condenser (c)
    dMcdt = m_U - m_c;
    dHcdt = m_U*hU - m_c*hc - Qc;
    
    Vcl = (1-beta_U)*Mc/rho_c;
    CondAlg1 = m_cold_in - m_cold_out;
    CondAlg2 = U_c*A_c*((TU_real-T_cold_out)/2+(Tc-T_cold_in)/2) - Qc;
    CondAlg3 = m_cold_in*cpW*(T_cold_out-T_cold_in) - Qc;
    CondAlg4 = Tc - TBU;
    CondAlg5 = k_c*(pc-p_out) - m_c;
    CondAlg6 = beta_U*Mc*R*TU_real/((Vc-Vcl)*MW) - pc;
    CondAlg7 = 1/(k_p*rho_Ref)*(rho_c-rho_Ref) + p_Ref - pc;
    CondAlg8 = Mc*hc - Hc;
        
    Alg = [Alg; CondAlg1;CondAlg2;CondAlg3;CondAlg4;CondAlg5;CondAlg6; ...
        CondAlg7;CondAlg8];
    diff = [diff; dMcdt; dHcdt];
