function [x_keys, z_keys, sol] = ...
    C3Feedforward(n, x_0, z_0, constants, control)
    import casadi.*
    ...
    w0      = constants(28);
    L       = constants(29);
    A_anto_c= constants(30);
    B_anto_c= constants(31);
    C_anto_c= constants(32);
    eta     = constants(33);
    VT      = constants(34);
    k_m     = constants(35);
    p_pump  = constants(36);
    ...
    % Control
    z = [z; dummy_zm; dummy_m_in_SP; dummy_v];
